      ...
      <div class="container-fluid">
        ...
        <div class="row" style='height: 550px;'>
          <div class="col-md-12">
            ...
            <div class="timeline">
              <?php 
                $notification_query = mysqli_query($conn, "SELECT * FROM investor_notifications WHERE notification_receiver = '$email' GROUP BY notification_details ORDER BY notification_date DESC");
