  ...
  <div class="content-wrapper">
    ...
    <section class="content" style='overflow-y: auto !important;box-sizing: border-box;'>
      <div class="row" style='height: 550px;'>
         <div class="col-md-6">
            <img src='../../assets/img/nairaquiz-rewards.jpeg' alt='image' style='width: 100%;height: 100%;'>
        </div>
        <div class="col-md-6">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <ul style='text-align: left;'>
                    ...
                    <li><b>Completion Requirement:</b> Players must answer all questions in their chosen format (5, 7, 10, or 14 questions).</li>
                ...
                <div class="col-12">
                    <?php 
                        if($wallet_amount < 100){
                            ...
                            echo "<input type='button' id='start' value='Start Quiz' class='btn btn-success float-left'>";
                        }
                    ?>
                    <input type="text" id="walletAmount" value="<?php echo $wallet_amount; ?>" hidden>
                    <input type="text" id="limit" value="<?php echo $type; ?>" hidden>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
...
<div id='notification-overlay'>
  <div id='notification-div'>
    <div id='close-notification'><i class="fa fa-times" aria-hidden="true"></i></div>
    <div id='icon-div'></div>
...
<div id='stake-overlay'>
  <form class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="number" class="form-control" id='availableAmount' name="available_amount" value="<?php echo $wallet_amount; ?>" disabled>
      </div>
    </div>
    <div class="form-group">
        <div class='form-text'>
            <label for="facebook" class="col-sm-2 col-form-label">Stake Amount (₦)</label>
        </div>
      <div class="col-sm-10">
        <input type="number" class="form-control" id='stakeAmount' name="withdrawal_amount" placeholder="Enter amount you want to play with">
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="offset-sm-2 col-sm-10">
          <center>
           <button type='button' class='btn btn-success' id='startQuiz'>Play</button>
        </center>
      </div>
    </div>
  </form>
...
<script src="<?php echo getCacheBustedUrl('../scripts/quiz.js'); ?>" type='module'></script>
</body>
</html>
