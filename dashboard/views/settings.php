          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <?php
                    $image = $profile === 'null' ? "<img src='../../assets/img/user.png' class='profile-user-img img-fluid img-circle' style='width: 100px !important;height: 100px !important;' alt='Admin Image'>"
                    : "<img src='../../uploads/$profile' class='profile-user-img img-fluid img-circle' style='width: 100px !important;height: 100px !important;' alt='Admin Image'>";
                    echo $image;
                ?>
                </div>
                ...
                <a href="#" class="btn btn-primary btn-block" id='update-profile'><b>Update Profile</b></a>
                  ...
                  <div class="tab-pane" id="settings" style="display: block;">
                    <form class="form-horizontal" id='details-form'>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="name" value='<?php echo $fullname; ?>' placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                    ...
                    <form class="form-horizontal" id='bank-form'>
                      <div class="form-group row">
                        ...
                        <div class="form-group row" style='display: none;'>
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="unique_code" id="uniqueCode" value="<?php echo $recipient_code; ?>" placeholder="Unique Code" disabled>
                          </div>
                        </div>
                      <div class="form-group row">
...
<script src="<?php echo getCacheBustedUrl('../scripts/bank.js'); ?>" type='module'></script>
