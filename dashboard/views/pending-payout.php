...
<head>
  ...
  <title>User | Pending Payout</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 id='payCounter'><b>Pending Payout</b></h1>
          </div>
          <div class="col-sm-6">
          ...
          <table class="table table-striped projects">
            ...
            <tbody>
              <?php
                ...
                $stmt = $conn->prepare("SELECT payment_amount FROM withdrawals WHERE payment_email = ? AND payment_status = 'Pending' ORDER BY payment_date DESC");
