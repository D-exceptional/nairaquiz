<?php
    ...
    if (isset($_GET['mailID'])) {
        ...
        $stmt = $conn->prepare("SELECT * FROM mailbox WHERE mailID = ?");
          ...
          <div class="col-md-3">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                <li class="nav-item">
                  <a href="../views/sent-mail.php" class="nav-link">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer bg-white">
              <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                <?php 
                  $sql = mysqli_query($conn, "SELECT mail_filename, mail_extension FROM sent_mail WHERE mailID = '$mailID'");   
